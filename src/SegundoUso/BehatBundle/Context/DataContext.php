...
class DataContext extends BehatContext implements KernelAwareInterface
{
    ...
    {
        foreach ($table->getHash() as $data) {
            $this->thereIsCategory($data['name']);
        }
    }

    /**
     * @Given /^I created a category "([^""]*)"$/
     */
    public function thereIsCategory($name)
    {
        $category = $this->getManager('category')->createCategory();
    ...
    protected function getManager($model)
    {
        return $this->getService('seguso.' . $model . '_manager');
    }


    /**
     * Get repository by entity's class name.
     *
     * @param string $entity
     *
     * @return mixed
    ...
    // NOTE I'm interested in the way how Sylius treat this
